...
public:
    robot_command_thread(const std::string node_name, const std::string& robot_ip = "");
...
public:
    explicit robot_recv_thread(const std::string node_name, const std::string& robot_ip = "");
    ~robot_recv_thread();
private:
